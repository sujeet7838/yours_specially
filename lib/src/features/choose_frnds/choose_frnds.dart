...
class ChooseFriends extends StatefulWidget {
  const ChooseFriends({Key? key}) : super(key: key);
                ...
                children: [
                  Center(
                    child: Padding(
                      ...
                      child: Text(
                        'Choose Your Closest Friends You Want',
              ...
              child: Padding(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    //       return ContactItem(
                    //           initials: _contactList[index].initials,
                    //           isSelected: _contactList[index].isSelected,
                    ...
                    ElevatedButton(
                      onPressed: () {
                        settingsBox.put(
                            'answeredOnboardingQuestionnaire', true);
